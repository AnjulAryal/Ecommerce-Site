...
let imageContainerDesktop = document.querySelector(".image-container-desktop");
let overlaps = document.querySelector(".overlap");
let counter = 0;
...
imageContainer.addEventListener("click",()=>{
    imageContainerOne.style.display = "grid";
});
